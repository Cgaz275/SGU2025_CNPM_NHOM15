...
export default function AllRestaurant() {
    ...
    const { 
        data: restaurants, // categories là mảng chứa các document Firestore
        loading, 
        error 
    } = useRestaurants();
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                    ...
                    {restaurants.map((restaurants) => (
                        <Link
                            ...
                            className="group"
                        >
                            <div className="bg-neutral-100 rounded-xl border border-black/10 overflow-hidden hover:shadow-lg transition cursor-pointer h-full">
