...
const AddressModal = ({ setShowAddressModal }) => {
    ...
    return (
        <form onSubmit={e => toast.promise(handleSubmit(e), { loading: 'Adding Address...' })} className="fixed inset-0 z-50 bg-black/40 backdrop-blur-sm h-screen flex items-center justify-center p-4 overflow-y-auto">
            <div className="flex flex-col gap-5 text-slate-700 w-full max-w-sm mx-auto my-8">
